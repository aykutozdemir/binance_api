...
addin_publisher_link = "https://github.com/aykutozdemir/binance_api"
addin_publisher_name = "Aykut OZDEMIR"
...
define_function(calcaddin_xml, \
	'BINANCEPRICE', 'Retrieve the latest price for a Binance Ticker', \
	[('symbol', 'The Binance Pair Ticker(e.g., ROSEUSDT)')])

define_function(calcaddin_xml, \
	'BINANCEHIGHPRICE', 'Retrieve the highest price for a Binance Ticker in last 24 hours', \
	[('symbol', 'The Binance Pair Ticker(e.g., ROSEUSDT)')])

define_function(calcaddin_xml, \
	'BINANCELOWPRICE', 'Retrieve the lowest price for a Binance Ticker in last 24 hours', \
	[('symbol', 'The Binance Pair Ticker(e.g., ROSEUSDT)')])

define_function(calcaddin_xml, \
	'BINANCEVOLUME', 'Retrieve the volume for a Binance Ticker in last 24 hours in base asset', \
	[('symbol', 'The Binance Pair Ticker(e.g., ROSEUSDT)')])

define_function(calcaddin_xml, \
	'BINANCEQUOTEVOLUME', 'Retrieve the quote volume for a Binance Ticker in last 24 hours in quote asset', \
	[('symbol', 'The Binance Pair Ticker(e.g., ROSEUSDT)')])
